function [weights, weightsPerBin, weightsPerShelf, cams, events, gt] = loadExperiment(tStr, experimentType, DATA_FOLDER, binWidth, systemParams)
    ...
    %%% FIXME: Temp to avoid running vision
    cams = [];
    return
